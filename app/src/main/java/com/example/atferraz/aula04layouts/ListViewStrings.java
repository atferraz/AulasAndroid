...
public class ListViewStrings extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter listViewAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, nomesAlunos);
